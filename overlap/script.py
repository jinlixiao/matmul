...
for tile_size in [1, 2, 3, 4, 6, 8, 12, 24]:
    file_path = f"output/time_for_tile_size_{tile_size}.txt"
...
plt.savefig('images/timing_analysis_combined_boxplot_iter100.png')
plt.show()
...
ax.legend()
plt.savefig('images/timing_analysis_combined_bar_chart_iter100.png')
plt.show()
